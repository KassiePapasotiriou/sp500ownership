...
We performed the data cleaning in three Python notebooks that can be found under the `data/` folder. Here we will provide an overview of what we have done. Please take a look at the notebooks if you need further detail.
