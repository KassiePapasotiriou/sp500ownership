...
```{r qplot57, fig.width=19, fig.height=9,message=FALSE}
# Libraries
library(ggplot2)
library(dplyr)
library("tidyverse")
...
very_popular_ridge %>%
  ...
  geom_line() +  
  scale_x_date(date_labels = "%b-%d-%Y", breaks = "2 month") + 
...
```{r qplot59, fig.width=19, fig.height=9, message=FALSE}
very_popular_ridge %>%
...
```{r qplot58, fig.width=19, fig.height=9,message=FALSE}
very_popular_ridge %>%
...
```{r qplot60, fig.width=12, fig.height=6,message=FALSE}
