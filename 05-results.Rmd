...
ggplot(arrange(df2_summary, desc(Avg_holding))[1:100,], aes(x = Avg_holding, y = reorder(Symbol, Avg_holding))) +
    geom_point(color = "blue") +
    theme_dotplot +
    theme(plot.title = element_text(size = 14), axis.text.y = element_text(size = rel(0.5))) +
    scale_x_continuous(labels = scales::comma, limits = c(0, 400000)) +
    xlab("Average Number of Account Owners") +
    ylab("Stock Ticker") +
    ggtitle("Average Account Ownership of the First 100 Companies by Popularity\nAug'18 - Aug'20")
```


```{r, fig.height= 10, message= FALSE}
ggplot(arrange(df2_summary, desc(Avg_holding))[101:200,], aes(x = Avg_holding, y = reorder(Symbol, Avg_holding))) +
    geom_point(color = "blue") +
    theme_dotplot +
    theme(plot.title = element_text(size = 14), axis.text.y = element_text(size = rel(0.5))) +
    scale_x_continuous(labels = scales::comma, limits = c(0, 400000)) +
    xlab("Average Number of Account Owners") +
    ylab("Stock Ticker") +
    ggtitle("Average Account Ownership of the Second 100 Companies by Popularity\nAug'18 - Aug'20")
```


```{r, fig.height= 10, message= FALSE}
ggplot(arrange(df2_summary, desc(Avg_holding))[201:300,], aes(x = Avg_holding, y = reorder(Symbol, Avg_holding))) +
    geom_point(color = "blue") +
    theme_dotplot +
    theme(plot.title = element_text(size = 14), axis.text.y = element_text(size = rel(0.5))) +
    scale_x_continuous(labels = scales::comma, limits = c(0, 400000)) +
    xlab("Average Number of Account Owners") +
    ylab("Stock Ticker") +
    ggtitle("Average Account Ownership of the Third 100 Companies by Popularity\nAug'18 - Aug'20")
```



```{r, fig.height= 10, message= FALSE}
ggplot(arrange(df2_summary, desc(Avg_holding))[301:400,], aes(x = Avg_holding, y = reorder(Symbol, Avg_holding))) +
    geom_point(color = "blue") +
    theme_dotplot +
    theme(plot.title = element_text(size = 14), axis.text.y = element_text(size = rel(0.5))) +
    scale_x_continuous(labels = scales::comma, limits = c(0, 400000)) +
    xlab("Average Number of Account Owners") +
    ylab("Stock Ticker") +
    ggtitle("Average Account Ownership of the Fourth 100 Companies by Popularity\nAug'18 - Aug'20")
```


```{r, fig.height= 10, message= FALSE}
ggplot(arrange(df2_summary, desc(Avg_holding))[401:494,], aes(x = Avg_holding, y = reorder(Symbol, Avg_holding))) +
    geom_point(color = "blue") +
    theme_dotplot +
    theme(plot.title = element_text(size = 14), axis.text.y = element_text(size = rel(0.5))) +
    scale_x_continuous(labels = scales::comma, limits = c(0, 400000)) +
    xlab("Average Number of Account Owners") +
    ylab("Stock Ticker") +
    ggtitle("Average Account Ownership of the Fifth 100 Companies by Popularity\nAug'18 - Aug'20")
```
...
ggplot(group1, aes(x = users_holding)) + geom_histogram(bins=50) + facet_wrap(~Symbol)+ theme(axis.text.x = element_text(size = 8)) + scale_x_continuous(label=comma) + labs(title = "Account Ownership Distribution of Top 5 Most Popular Companies", x = "Number of Account Who Own the Stock") 
```
...
df2 %>% filter(Symbol %in% very_pop) %>%  ggplot(aes(x = reorder(Symbol, -users_holding, median), y = users_holding)) + geom_boxplot() + xlab("Top 5 Most Popular Companies") + ylab ("Number of Accounts Who Own the Stock") + stat_summary(fun = mean, geom = "point", shape = 1, size = 3)
